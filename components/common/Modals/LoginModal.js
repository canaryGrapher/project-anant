...
const LoginModal = () => {
    ...
    return (
      <>
          <>
            <div
              className="overflow-x-hidden overflow-y-auto fixed backdrop-blur-md inset-0 z-50 outline-none focus:outline-none"
            >
                <div className="min-h-screen px-2 flex justify-center items-center fixed md:inset-0" style={{ backgroundColor: "rgba(0, 0, 0, 0.8)" }}>
