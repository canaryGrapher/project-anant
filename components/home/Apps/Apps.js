      ...
      <main className="flex flex-col items-center w-screen py-20 lg:pt-32">
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 w-5/6 mx-auto gap-x-5 gap-y-3">
          <Link href="/apps/mxene">
            <div className="flex flex-col bg-gray-100 p-3 lg:p-5 rounded-lg cursor-pointer">
          ...
          <div className="opacity-50 flex flex-col bg-gray-100 md:p-5 p-3 rounded-lg cursor-not-allowed">
